...
{
	static const GIchar *szNoError = "no error";
	...
	static const GIchar *szInvalidMesh = "non-manifold mesh";
	static const GIchar *szInvalidCut = "incomplete mesh cut";
	static const GIchar *szInvalidParameterization = "invalid parameterization";
	static const GIchar *szNumericalError = "error in numerical method";
	static const GIchar *szUnsupportedOperation = "operation not supported by system";
...
void GIContext_error(GIContext *context, GIenum error)
{
	...
	if(context->error_cb)
		...
		GIDebug(fprintf(stderr, "OpenGI error: %s!\n", giErrorString(error)));
}
