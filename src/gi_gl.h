...
#ifdef _WIN32
#include <Windows.h>
#define GI_GL_PROC_ADDRESS(funcName)    wglGetProcAddress(#funcName)
#elif defined(__APPLE__)
#define GI_GL_PROC_ADDRESS(func)        func
#else
#include <GL/glx.h>
#define GI_GL_PROC_ADDRESS(funcName)    glXGetProcAddress(#funcName)
#endif
