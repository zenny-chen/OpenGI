...
typedef uint8_t			GIboolean;					/**< Boolean type. */
typedef unsigned int	GIbitfield;					/**< Bitfield type. */
typedef char			GIchar;						/**< Character type. */
typedef int8_t			GIbyte;						/**< 1 byte signed integer type. */
typedef int16_t			GIshort;					/**< 2 byte signed integer type. */
typedef int				GIint;						/**< 4 byte signed integer type. */
typedef int				GIsizei;					/**< Size type. */
typedef uint8_t			GIubyte;					/**< 1 byte unsigned integer type. */
typedef uint16_t		GIushort;					/**< 2 byte unsigned integer type. */
typedef unsigned int	GIuint;						/**< 4 byte unsigned integer type. */
typedef float			GIfloat;					/**< Single precission floating point type. */
typedef double			GIdouble;					/**< Double precission floating point type. */
typedef uint16_t		GIhalf;						/**< Half precission floating point type. */
 ...
 *  \{
 */
#define GI_TRUE                          (GIboolean)1		/**< Boolean value true. */
#define GI_FALSE                         (GIboolean)0		/**< Boolean value false. */
#define GI_NULL                          NULL				/**< Zero value. */
#define GI_NONE                          0					/**< Zero identifier. */
#define GI_ALL_PATCHES                   -1ULL				/**< Whole mesh. */
/** \} */
...
//GIAPI GIint         GIAPIENTRY giCutterParameterf(GIenum pname, GIfloat param);
